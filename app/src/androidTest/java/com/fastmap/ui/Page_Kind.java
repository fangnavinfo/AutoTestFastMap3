 ...
 */
public class Page_Kind extends Page_Base_Tips
{
    @FindResource(Id="card_high_speed", ios_name="gridView_k1.png")
    public static String HIGH_SPEED;

    @FindResource(Id="card_city_high_speed", ios_name="gridView_k2.png")
    public static String CITY_HIGH_SPEED;

    @FindResource(Id="card_national_rd", ios_name="gridView_k3.png")
    public static String NATIONAL_RD;

    @FindResource(Id="card_provincial_rd", ios_name="gridView_k4.png")
    public static String PROVINCIAL_RD; //省道

    @FindResource(Id="card_county_rd", ios_name="gridView_k6.png")
    public static String COUNTY_RD; //省道
    
    @FindResource(Id="card_other_rd", ios_name="gridView_k8.png")
    public static String OTHER_RD;  //其他道路
    
    @FindResource(Id="card_nine_rd", ios_name="gridView_k9.png")
    public static String NINE_RD;  //9级辅路

    @FindResource(Id="card_pedestrian_rd", ios_name="gridView_k10.png")
    public static String PEDESTRIAN_RD;  //行人道路
    
    @FindResource(Id="card_people_crossing", ios_name="gridView_k11.png")
    public static String PEOPLE_CROSS_RD; //人渡
    
    @FindResource(Id="card_ferry", ios_name="gridView_k13.png")
    ...
    @FindResource(Id="lane_num_2", ios_name="gridView_lane_num_2.png")
